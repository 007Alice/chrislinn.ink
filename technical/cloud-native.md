...
+++++
1. 什么是K8S? 直接上来说好处有点懵
2. 在介绍依赖性的时候是不是该说下k8s这一套为什么会没有依赖性呢
3. 感觉缺少一些内部的细节介绍，听众感觉有点浮于表面
4. 感觉任何原来的问题，要形成对比
5. 介绍物理服务器的话感觉缺少图，重点内容没有在ppt上显示
6. 大多数的听众是迷茫的，要用标题标注现在说的是什么，然后每个话题要把重点标注出来
...
11. 一页面太多的文字，读文字的话效果不会特别好
12. PPT总页数控制在25页之内，太长会迷失
13. 没有感受到serverMesh的好处，解决了什么问题
14. isto的架构，特点，好处？
15. 关于一些使用细节，当场讲了大多人都记不错
16. 专注于技术架构，放弃使用方面
17. 关于k8s， isto的架构带来的好处，感觉偏少
18. elk, kibna感觉是传统的，和这次的课题关系不大
19. 将如何迁移已经是实际使用层的了
20. 来得及吗，会不会淘汰不属于核心？是为了向技术介绍为什么牛B,是什么原因牛B，而不是说服别人使用
21. PPT只要标注出核心点，然后自己讲，如果文字多了，那演讲效果就没那么好了
+++++
